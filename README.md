...
<head>
    ...
    <style>
        ...
        header {
            ...
            text-align: center;
            padding: 1em;
            background-color: #4c2b80; /* Dark purple header background color */
            margin-bottom: 20px;
            display: flex;
        ...
        nav {
            background-color: #333; /* Dark grey background for tabs and search bar */
            padding: 10px;
            display: flex;
        ...
        .tab-line a {
            ...
            margin: 0 5px;
            border-radius: 5px;
            border: 2px solid #555; /* Border color for tabs */
        ...
        .form-box {
            width: 90%; /* Updated width to match Instagram login form size */
            max-width: 400px; /* Added max-width to limit form width */
            margin: 20px auto;
            padding: 20px;
            border: 2px solid #ffffff; /* Neo light style border */
            border-radius: 10px;
        ...
        button {
            background-color: #4c2b80; /* Dark purple button color */
            color: white;
            padding: 10px 20px;
            border: 2px solid #4c2b80; /* Dark purple border */
            border-radius: 5px;
            cursor: pointer;
            transition: background-color 0.3s ease;
            font-family: 'Poppins', sans-serif;
        ...
        button:hover {
            background-color: #2c1a50; /* Darker purple on hover */
        }
...
<body>
    ...
    <div id="peopleTracker" class="form-box hidden">
        ...
        <!-- Create person profile form goes here -->
    ...
    <script>
        ...
        function showSection(sectionId) {
            ...
            // Show/hide tabs based on the section
        ...
        function checkLogin() {
            // Check login credentials against specified users
            ...
            if (validUsers[username] === password) {
                // Show the Clue Organization section after successful login
        ...
        function signup() {
            ...
            // Store new user details (e.g., in local storage)
            // Here, I'm just displaying an alert for demonstration
        ...
        function addClue() {
            // Get values from the form and create a clue object
            ...
            const evidencePhoto = document.getElementById('evidencePhoto').files[0]; // Updated to get file object
            ...
            const clue = {
                ...
                dateDiscovered,
                description,
                evidencePhoto // Updated to store file object
            };

            // Add the clue to the clues database
        ...
        function searchPerson() {
            ...
            // Search for the person in the clues database
            const personData = cluesDatabase.find(clue => clue.personName === searchName);

            // Display search results in the People Tracker section
            if (personData) {
